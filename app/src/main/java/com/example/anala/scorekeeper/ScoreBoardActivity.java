...
public class ScoreBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Get the name for Player 1 from MainActivity */
        Intent intent = getIntent();
        String p1name = intent.getStringExtra(MainActivity.EXTRA_MESSAGE1);
        String p2name = intent.getStringExtra(MainActivity.EXTRA_MESSAGE2);

        TextView player1textView = findViewById(R.id.playerOne);
        player1textView.setText(p1name);

        TextView player2textView = findViewById(R.id.playerTwo);
        player2textView.setText(p2name);
    }
